...
<input type="hidden" name="nim" value="<?= $ad['nim'] ?>" hidden>
	<tr >
		<td>NIM</td>
		<td>:</td>
		<td>
	...
	<td>Jurusan</td>
		<td>:</td>
		<td>
			<input class="form-control"  type="text" name="jurusan" size="30" maxlength="20" value="<?= $ad['jurusan'] ?>">
		</td>
	</tr>
	<tr>
	<td>Program Studi</td>
		<td>:</td>
		<td>
			<input class="form-control"  type="text" name="program_studi" size="30" maxlength="20" value="<?= $ad['program_studi'] ?>">
		</td>
	</tr>
	<tr>
		<td></td>
